...
const Footer = () => {
  return <footer className="bg-orange-50 w-full py-12 mt-16 text-amber-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex">
              ...
              <button className="bg-amber-500 text-white p-2 rounded-r-md hover:opacity-90">Đăng Ký</button>
            </div>
          </div>
        </div>
