...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col">
      <Link to={`/products/${id}`}>
        <img src={image || `https://placehold.co/400x400?text=Product+${id}`} alt={title} className="w-full h-56 object-cover" />
      </Link>
