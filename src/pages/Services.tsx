...
const Services = () => {
  return <div className="min-h-screen bg-white text-amber-800 flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-grow">
        <h1 className="text-3xl font-bold mb-8 text-amber-800">Dịch Vụ Của Chúng Tôi</h1>
        {/* Filter/Search Bar */}
        <div className="flex items-center mb-8 bg-orange-50 p-3 rounded-lg shadow-sm">
          ...
          <div className="flex-grow flex items-center">
            ...
            <input type="text" placeholder="Tìm kiếm dịch vụ..." className="bg-transparent outline-none flex-grow text-amber-800" />
          </div>
        </div>
        {/* Services Grid */}
