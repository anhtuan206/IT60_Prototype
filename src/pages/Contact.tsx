    ...
    <div className="min-h-screen bg-white text-neutral-text flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-grow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-accent-beige rounded-md p-8">
            <h2 className="text-2xl font-bold mb-6 text-neutral-text">Gửi Tin Nhắn</h2>
            <form className="space-y-4">
              ...
              <button type="submit" className="w-full bg-warm-gold text-white py-3 rounded-md font-semibold hover:opacity-90 transition-opacity">Gửi</button>
            </form>
          </div>
          ...
          <div className="space-y-8">
            <div>
                <h2 className="text-2xl font-bold mb-6 text-neutral-text">Thông Tin Liên Hệ</h2>
                <div className="space-y-4">
                    <div className="flex items-start">
                        <MapPin size={24} className="mr-4 mt-1 text-warm-brown"/>
                        <div>
                    ...
                    <div className="flex items-start">
                        <Phone size={24} className="mr-4 mt-1 text-warm-brown"/>
                        <div>
                    ...
                    <div className="flex items-start">
                        <Mail size={24} className="mr-4 mt-1 text-warm-brown"/>
                        <div>
            ...
            <div>
                <h2 className="text-2xl font-bold mb-6 text-neutral-text">Bản Đồ</h2>
                <div className="aspect-w-16 aspect-h-9 rounded-md overflow-hidden shadow-md">
                    <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.447176339033!2d106.6954304147498!3d10.77698999232085!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f3a3935c07d%3A0x2843a2f6e6f2f4b!2sBen%20Thanh%20Market!5e0!3m2!1sen!2s!4v1678886 Ben Thanh Market location" 
                        width="100%" 
                        height="100%" 
                        style={{ border: 0 }} 
