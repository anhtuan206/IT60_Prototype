...
const AdminOrdersList = () => {
  ...
  const orders = [
    { id: '#1256', customer: 'Nguyễn Văn An', total: '1.250.000₫', status: 'paid', created: '25/09/2025' },
    { id: '#1255', customer: 'Trần Thị Bích', total: '850.000₫', status: 'pending', created: '25/09/2025' },
    { id: '#1254', customer: 'Lê Hoàng', total: '2.100.000₫', status: 'shipped', created: '24/09/2025' },
    { id: '#1253', customer: 'Phạm Minh', total: '450.000₫', status: 'cancelled', created: '23/09/2025' },
    { id: '#1252', customer: 'Vũ Thị Lan', total: '1.800.000₫', status: 'paid', created: '22/09/2025' },
  ];
  ...
  return (
    <AdminLayout title="Đơn hàng" breadcrumbs={breadcrumbs}>
