...
const AdminAppointmentsList = () => {
  ...
  const appointments = [
    { id: '#A-056', customer: 'Trần Thị Bích', pet: 'Milo', service: 'Cắt tỉa lông', datetime: '28/09/2025 14:00', status: 'confirmed' },
    { id: '#A-055', customer: 'Nguyễn Văn An', pet: 'KiKi', service: 'Lưu trú cao cấp', datetime: '27/09/2025 10:00', status: 'requested' },
    { id: '#A-054', customer: 'Lê Hoàng', pet: 'Heo', service: 'Tắm và vệ sinh', datetime: '26/09/2025 16:30', status: 'cancelled' },
    { id: '#A-053', customer: 'Phạm Minh', pet: 'Bông', service: 'Dịch vụ spa', datetime: '26/09/2025 11:00', status: 'confirmed' },
    { id: '#A-052', customer: 'Vũ Thị Lan', pet: 'Gấu', service: 'Lưu trú cao cấp', datetime: '25/09/2025 18:00', status: 'completed' },
  ];

  const columns = [
    { header: 'Appt ID', accessor: 'id' },
    { header: 'Khách hàng', accessor: 'customer' },
    { header: 'Thú cưng', accessor: 'pet' },
    { header: 'Dịch vụ', accessor: 'service' },
    { header: 'Ngày & Giờ', accessor: 'datetime' },
  ...
  return (
    <AdminLayout title="Lịch hẹn" breadcrumbs={breadcrumbs}>
